...
class TestAttendance(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.teacher = self.env.ref('IDAFormation.demo_school_teacher_2')
        self.school_std = self.env.ref('IDAFormation.demo_school_standard_2')
        self.academic_year = self.env.ref('IDAFormation.demo_academic_year_2')
        self.month = self.env.ref('IDAFormation.demo_academic_month_current_6')
        self.stud_id = self.env.ref('IDAFormation.demo_student_student_5')
